...
import type { Team, TeamMember } from './cost-calculator/types';
...
const TeamManager: React.FC = () => {
  ...
  const handleInviteMember = async () => {
    ...
    if (!error) {
      setMembers([...members, { team_id: selectedTeam.id, user_id: users.id, role: 'member', joined_at: new Date().toISOString() }]);
      setInviteEmail('');
