...
import { Package, Layers, Weight, Clock, Zap } from 'lucide-react';
import { useFormatCurrency } from '@/hooks/useFormatCurrency';
import type { ProjectSummaryProps, CostBreakdownPanelProps, SalePricePanelProps } from '@/types';
import CostBreakdownPanel from './CostBreakdownPanel';
import SalePricePanel from './SalePricePanel';

interface SummaryTabsPanelProps {
  // ProjectSummary props
  pieces: ProjectSummaryProps['pieces'];
  ...
  // SalePrice props
  salePrice: SalePricePanelProps['salePrice'];
  vatPercentage: number;
  profitMargin: number;
}

const SummaryTabsPanel: React.FC<SummaryTabsPanelProps> = ({
  pieces,
  totalFilamentWeight,
  totalPrintHours,
  totalFilamentCost,
...
export default SummaryTabsPanel;
