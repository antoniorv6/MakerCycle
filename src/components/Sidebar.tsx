...
import { Calculator, TrendingUp, FolderOpen, Settings, Menu, X, LogOut, Home, Users, User, BarChart3 } from 'lucide-react'
...
const menuItems = [
  ...
  { id: 'kanban', label: 'Tablero Kanban', icon: BarChart3 },
